    ...
    <div className="bg-gray-50">
      <div className="container mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20">
        <div className="text-center mb-12 sm:mb-16">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 mb-4">About Sunil Furniture</h1>
        ...
        <div className="flex flex-col lg:flex-row items-center bg-white rounded-xl shadow-md overflow-hidden">
          ...
          <div className="lg:w-1/2 w-full p-6 sm:p-8 md:p-12">
